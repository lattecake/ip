...
import (
	...
	"github.com/lattecake/ip/pkg/endpoint"
	"github.com/lattecake/ip/pkg/http"
	"github.com/lattecake/ip/pkg/service"
...
var fs = flag.NewFlagSet("ip", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "ip")
